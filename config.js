...
module.exports = {
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || 'false',
  BOT_INFO: process.env.BOT_INFO || '𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑;ན🏴‍☠️⃝🅐ϲԑ 𝚔𝖎𝐫қ ⟨𝕯⟩;254726856795;https://telegra.ph/file/c9f1fbd5b78d902762e5f.jpg',
  AUDIO_DATA: process.env.AUDIO_DATA || '𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑;ན🏴‍☠️⃝🅐ϲԑ 𝚔𝖎𝐫қ ⟨𝕯⟩;https://telegra.ph/file/c9f1fbd5b78d902762e5f.jpg',
  STICKER_DATA: process.env.STICKER_DATA || '𝙸 αɱ ค̡ƈє™⟬𝟭⟭;ན🏴‍☠️⃝🅐ϲԑ 𝚔𝖎𝐫қ ⟨𝕯⟩',
  ERROR_MESSAGE: toBool(process.env.ERROR_MESSAGE, 'false'),
